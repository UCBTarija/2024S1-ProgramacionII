...
public class Principal extends javax.swing.JFrame implements ActionListener {
    ...
    public void actionPerformed(java.awt.event.ActionEvent evt) {
        if (evt.getSource() == btnAdicionar) {
            Principal.this.btnAdicionarActionPerformed(evt);
        }
    ...
    private void btnAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdicionarActionPerformed
        ...
        persona.setFecha(txtFecha.getText());
    ...
    private void ActualizarDatos() {
        ...
        model.setRowCount(0); //borrar el contenido

        for (Persona persona : personas) {
           model.addRow(new Object[]{persona.getCi(), persona.getNombre(), persona.getFecha()});
        }
    }
